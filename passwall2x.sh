...
for feed in passwall_luci passwall_packages passwall2; do
  echo "src/gz $feed https://master.dl.sourceforge.net/project/openwrt-passwall-build/releases/packages-$release.02/$arch/$feed" >> /etc/opkg/customfeeds.conf
done
...
uci set passwall2.Direct.remarks='RU'
